...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "The ability to host SignPortal entirely on our own infrastructure was the deciding factor. Finally, an e-signature solution that meets our strict data sovereignty requirements.",
      name: "Jamie Marshall",
      company: "CISO, National Health Framework",
      image:
    ...
    {
      quote:
        "SignPortal has revolutionized how we handle sensitive contracts. The automated workflows save us hours every week and the audit trails are flawless.",
      name: "Sarah Chen",
      company: "VP Legal Operations, TechFlow",
      image:
    ...
    {
      quote:
        "It's incredibly lightweight yet powerful. Deployment in our air-gapped environment took less than an hour, and user adoption was immediate.",
      name: "Marcus Rodriguez",
      company: "IT Director, SecureGov Services",
      image:
