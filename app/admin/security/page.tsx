      ...
      <header className="bg-slate-900/80 backdrop-blur-sm border-b border-slate-700 sticky top-0 z-50">
        <div className="max-w-[1400px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-lg hover:from-amber-600 hover:to-orange-700 transition-colors">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-slate-400">Configure authentication, roles, and security policies</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
              ...
              <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-300 font-medium">Native OAuth Support</p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Identity Provider</label>
                  <select
                    value={oauthConfig.provider}
                    onChange={(e) => setOauthConfig({...oauthConfig, provider: e.target.value})}
                    className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                  >
                    <option value="azure">Azure Active Directory</option>
                    <option value="google">Google Workspace</option>
                    <option value="okta">Okta</option>
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Tenant ID / Domain</label>
                  <input
                    type="text"
                    value={oauthConfig.tenantId}
                    onChange={(e) => setOauthConfig({...oauthConfig, tenantId: e.target.value})}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={oauthConfig.clientId}
                    onChange={(e) => setOauthConfig({...oauthConfig, clientId: e.target.value})}
                    className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={oauthConfig.clientSecret}
                      onChange={(e) => setOauthConfig({...oauthConfig, clientSecret: e.target.value})}
                      className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50 pr-12"
                    />
                    <button
                      onClick={() => setShowSecret(!showSecret)}
              ...
              <div className="mt-6 pt-6 border-t border-slate-700">
                <h4 className="font-medium text-white mb-4">Provisioning Settings</h4>
                <div className="space-y-3">
                  <label className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-slate-300">Auto-provision users on first login</span>
                  </label>
                  <label className="flex items-center gap-3">
                    <input
                      type="checkbox"
                      ...
                      className="w-4 h-4 rounded border-slate-500 text-amber-500 focus:ring-amber-500/50"
                    />
                    <span className="text-slate-300">Enable SSO authentication</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {[
                ...
                <div key={provider.name} className="bg-slate-800/50 rounded-xl border border-slate-700 p-4">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">{provider.icon}</span>
                    <span className="font-medium text-white">{provider.name}</span>
                  </div>
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    provider.status === "Connected" ? "bg-green-500/20 text-green-400" : "bg-slate-700 text-slate-400"
                  }`}>
                    {provider.status}
                  </span>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
              ...
              <div className="space-y-4">
                {roleHierarchy.map((role, index) => (
                  <div key={role.role} className={`border rounded-xl p-6 ${
                    role.color === "amber" ? "border-amber-500/30 bg-amber-900/10" :
                    role.color === "purple" ? "border-purple-500/30 bg-purple-900/10" :
                    role.color === "blue" ? "border-blue-500/30 bg-blue-900/10" :
                    role.color === "green" ? "border-green-500/30 bg-green-900/10" :
                    "border-slate-600 bg-slate-800/50"
                  }`}>
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          role.color === "amber" ? "bg-amber-500/20" :
                      ...
                      <span className="text-xs text-slate-500">Level {index + 1}</span>
                    </div>
                    
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <p className="text-xs text-slate-400 uppercase tracking-wider mb-2">Permissions</p>
                        <ul className="space-y-1">
                          {role.permissions.map((perm, i) => (
                      ...
                      <div className="flex items-end">
                        <p className="text-sm text-slate-400 italic">{role.note}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-xl p-6">
              <h4 className="font-semibold text-white mb-4">Access Control Philosophy</h4>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="flex items-start gap-3">
                  <Lock className="w-5 h-5 text-purple-400 mt-0.5" />
                  <div>
                    <p className="font-medium text-white text-sm">Principle of Least Privilege</p>
                    <p className="text-xs text-slate-400">Users receive only necessary permissions</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Database className="w-5 h-5 text-blue-400 mt-0.5" />
                  <div>
                    <p className="font-medium text-white text-sm">Tenant Isolation</p>
                    <p className="text-xs text-slate-400">No cross-enterprise data access</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Key className="w-5 h-5 text-green-400 mt-0.5" />
                  <div>
                    <p className="font-medium text-white text-sm">Encrypted Access</p>
                    <p className="text-xs text-slate-400">All data encrypted at rest & transit</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === "mfa" && (
          <div className="space-y-6">
            <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="flex items-center justify-between p-4 bg-slate-700/30 rounded-lg mb-4">
                    <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      checked={mfaSettings.required}
                      onChange={(e) => setMfaSettings({...mfaSettings, required: e.target.checked})}
                      className="w-5 h-5 rounded border-slate-500 text-amber-500 focus:ring-amber-500/50"
                    />
                  </label>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">Grace Period (Days)</label>
                    <input
                      type="number"
                      value={mfaSettings.graceperiod}
                      onChange={(e) => setMfaSettings({...mfaSettings, graceperiod: parseInt(e.target.value)})}
                      className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                    />
                    <p className="text-xs text-slate-400 mt-1">Days before MFA enforcement for new users</p>
                  </div>
                </div>

                <div>
                  <p className="text-sm font-medium text-slate-300 mb-3">Allowed MFA Methods</p>
                  <div className="space-y-3">
                    {[
                      ...
                      { id: "fido2", label: "Hardware Security Key (FIDO2)", icon: Fingerprint }
                    ].map((method) => {
                      const Icon = method.icon
                      return (
                        <label key={method.id} className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg cursor-pointer hover:bg-slate-700/50">
                          <input
                            type="checkbox"
                            checked={mfaSettings.methods.includes(method.id)}
                            onChange={(e) => {
            ...
            <div className="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Standard verification with network connectivity</p>
                  </div>
                </div>
                ...
                <div className="bg-slate-700/30 rounded-lg p-6 space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white font-medium">Email verification mandatory</p>
                      <p className="text-sm text-slate-400">Prior to signature execution</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Secure verification link or OTP</p>
                      <p className="text-sm text-slate-400">Sent to signer&apos;s email address</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Validated identity confirmation</p>
                      <p className="text-sm text-slate-400">Required before signature completion</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Full audit trail generated</p>
                      <p className="text-sm text-slate-400">With timestamp and IP logging</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Offline Mode</h4>
                    <p className="text-sm text-slate-400">For on-premises or air-gapped deployments</p>
                  </div>
                </div>
                ...
                <div className="bg-slate-700/30 rounded-lg p-6 space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white font-medium">Pre-generated verification tokens</p>
                      <p className="text-sm text-slate-400">Or locally validated credentials</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-amber-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Cryptographic verification</p>
                      <p className="text-sm text-slate-400">Ensures signature authenticity without network</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-amber-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Secure sync when connectivity restored</p>
                      <p className="text-sm text-slate-400">Signed artifacts synchronize automatically</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle className="w-5 h-5 text-amber-400 mt-0.5" />
                    <div>
                      <p className="text-white font-medium">Local audit logs maintained</p>
                      <p className="text-sm text-slate-400">Within the enterprise silo</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">OTP Expiry (minutes)</label>
                  <input
                    type="number"
                    value={verificationSettings.otpExpiry}
                    onChange={(e) => setVerificationSettings({...verificationSettings, otpExpiry: parseInt(e.target.value)})}
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-2">Max Verification Attempts</label>
                  <input
                    type="number"
                    value={verificationSettings.maxAttempts}
                    onChange={(e) => setVerificationSettings({...verificationSettings, maxAttempts: parseInt(e.target.value)})}
